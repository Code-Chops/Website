...
{
	public string FullTitle { get; } = CreateMember("Welcome to CodeChops").Value;
	public string Author { get; } = CreateMember("Logo, design and website by CodeChops").Value;
...
CodeChops preferably delivers full-stack solutions in order to provide a seamless integrated experience.
	").Value;
	public string Title { get; } = CreateMember("Welcome").Value;
}

public record HomeResourceNL : MagicStringEnum<HomeResourceNL>, IHomeResource
{
	public string FullTitle { get; } = CreateMember("Welkom bij CodeChops").Value;
	public string Author { get; } = CreateMember("Logo, design en website door CodeChops").Value;
	public string Paragraph1 { get; } = CreateMember(@"
...
").Value;
	public string Title { get; } = CreateMember("Welkom").Value;
}